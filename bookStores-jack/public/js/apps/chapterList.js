require(["headerRender", "locationFormat", "render", "bscroll", "locationStorage"], function (headerRender, locationFormat, render, bscroll, locationStorage) {
    ...
    $.ajax({
        ...
        success:function (data) { 
            ...
            myScroll.scrollToElement($("ul.chapter_list li").eq(tag).get(0));
            $("ul.chapter_list li").eq(tag).addClass("active");
    ...
    function listClick() {
        $("ul.chapter_list li").on("click",function () {
            ...
            window.location.href = "../../page/artical.html?fiction_id=352876&chapterNum=" + $(this).index();
        });
    }
});