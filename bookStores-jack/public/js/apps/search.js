require(["jquery", "headerRender", "render", "text!bookLRtpl", "locationStorage"], function ($, headerRender, render, bookLRtpl, locationStorage) {
    function init() {
        //1.点击返回上一步
        headerRender({
            isSearch: true
        ...
        this.searchHistory = locationStorage.get("history") || [];
         render(this.searchHistory, $("#search_history_tag_render"), $("ul.search_history_tag"),true);
    ...
    init.prototype.Render = function (val) {
        ...
        function g() {  
            that.list.html("");
            that.searchHistory = locationStorage.get("history");
                render(that.searchHistory, $("#search_history_tag_render"), $("ul.search_history_tag"),true);
        }
